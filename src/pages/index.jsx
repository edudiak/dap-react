  ...
  return (
    <div ref={root}>
      ...
      >
        ...
        <div ref={section1_panel2} className="panel w-full pb-[20vw] pt-[10vw]">
      ...
      >
        ...
        <div ref={section3_panel1} className="panel relative px-[5%] py-[10vw]">
          <h2
          ...
          >
            <p className="text-[clamp(1rem,1.1vw,2.5rem)] leading-snug text-purple-light">
              ...
              Dog Park, a private, online community where dog owners can
              interact with other participants, join clubs, post cute dog pics,
              attend monthly Pack Appreciation Events, and have insider access
              ...
              <div className="w-1/2">
                <div className="max-w-[40vw] text-purple-200">
                  ...
                  <p className="max-w-[35vw] text-[clamp(1rem,1.1vw,2.5rem)] leading-snug">
                    ...
                    smaller cohorts, we conduct physical sampling from the home
                    environment.
                  </p>
                </div>
              </div>
              ...
              <div className="w-1/2">
                <div className="max-w-[40vw] text-purple-200">
                  ...
                  <p className="max-w-[35vw] text-[clamp(1rem,1.1vw,2.5rem)] leading-snug">
                    ...
                    condition that is analogous to Alzheimer’s disease in
                    humans. We’ve designed a comprehensive program to study all
                    phases of cognitive development, health, and disease through
                    surveys, interactive games that owners play with their dogs,
                    and even an opportunity for interested participants to
                    donate their dog’s body to science at the end of their
                    natural lifespan.
                  </p>
                </div>
              </div>
        ...
        >
          <div className="flex gap-[1vw]">
            ...
            <div className="relative w-1/6">
              ...
              >
                <div className="relative w-full">
                  <p className="mb-[1vw] text-[1.3vw] leading-none">Genetics</p>
                  <p className="inline-block rounded-full border border-white px-4 py-1 text-xs">
                    explore
                  </p>
                </div>
            ...
            <div className="relative w-1/6">
              ...
              >
                <div className="relative w-full">
                  <p className="mb-[1vw] text-[1.3vw] leading-none">Activity</p>
          ...
          <div className="relative z-[1] w-3/4">
            ...
            >
              <p className="mb-[.7vw]">
                ...
                health and wellbeing of their owners. They give us comfort, joy,
                and unconditional love. Being a part of this study, gives each
                and every one of us a chance to enhance the lives of future
                generations of dogs.
              </p>
          ...
          <div className="flex gap-[2vw] pl-[5%]">
            {[...Array(3)].map((card, index) => (
              <div
                ...
                className={`relative flex-1 shrink-0 transform overflow-hidden rounded-[2vw] bg-white ${
                  index === 0
                    ? ''
                    : index === 1
                    ? 'translate-y-[5vw]'
                    : '-mr-[20%] translate-y-[10vw]'
                }`}
              >
                <div className="absolute left-0 top-0 h-full w-full shadow-[inset_0px_0px_10px_rgba(0,0,0,0.4)]" />
                <div className="p-[1.3vw]">
                  <div className="flex justify-between uppercase text-purple-primary">
                    <div>09.12.2022</div>
                    <div>Scientific Results</div>
                  </div>
                  <h4 className="my-[1vw] text-[1.6vw] font-medium text-purple-primary">
                    Demographic factor associated with joint supplement use in
                    dogs from the Dog Aging Project
                  </h4>
                  <div className="mb-[1.8vw] text-[.95vw] leading-tight text-[#7B7B7B]">
                  ...
                  <Link
                    href="#"
                    className="text-[.95vw] font-bold text-purple-primary"
                  >
                    Read More
                  </Link>
                </div>
                <div className="overflow-hidden rounded-tl-full rounded-tr-full">
                  <img
          ...
          <div className="mt-[5%] flex gap-[2vw] pl-[5%]">
            {[...Array(3)].map((card, index) => (
              <div
                key={index}
                data-speed={1.0 + index * 0.05}
                className={`relative flex-1 shrink-0 transform overflow-hidden rounded-[2vw] bg-white shadow-[inset_0px_0px_10px_rgba(0,0,0,0.4)] ${
                  index === 0
                    ? ''
                    : index === 1
                    ? 'translate-y-[5vw]'
              ...
              >
                ...
                <div className="overflow-hidden rounded-tl-full rounded-tr-full">
                  <img
                    src={`/images/blog/blog-grid-${index + 4}.jpg`}
                    alt="blog-grid-1"
                  />
                </div>
              </div>
        ...
        <div className="flex">
          <div className="flex w-1/2 items-center bg-[#AF4A40] pl-[5%] pr-[4%]">
            <div className="py-[5vw]">
              <h2 className="text-[clamp(3rem,3.15vw,6rem)] text-white">
                Join the effort to extend the lifespan of pets and their owners.
              </h2>
              <div className="pb-[8vw] pt-[5vw] text-[1.2vw] leading-snug text-[#FFDADA]">
                We have established the Dog Aging Project as an engine for
                innovation. While core research activities are supported by the
                National Institute on Aging, a division of the National
                Institutes of Health, we are actively seeking additional support
                to sustain and expand our existing initiatives and to develop
                new, cutting-edge programs that will benefit dogs and people
                too.
              </div>
              <div className="text-center">
                <Link
                  href="#"
                  className="inline-block rounded-full bg-[#f7f3ff] px-[1.8vw] py-[1.1vw] text-[clamp(1rem,1.1vw,4rem)] font-bold leading-none text-purple-secondary shadow-[inset_0px_0px_15px_5px_rgba(0,0,0,0.3);] transition hover:bg-black hover:text-white"
                >
                  Donate Now
                </Link>
              </div>
      ...
      <div
        className="bg-[#6543A5] px-[5%] py-[10vw]"
        style={{
          backgroundImage: 'url(/images/dap-bg-noise-20.png)',
          backgroundBlendMode: 'overlay, normal, normal',
        }}
      >
        <h2 className="mb-[3vw] ml-auto mr-[5%] max-w-[50%] text-[clamp(3rem,3.15vw,6rem)] text-[#D8C4FF]">
          Our Stats Show the Scale & Scope of Our Project
        </h2>
        <div className="flex items-start">
          <p className="mr-[5vw] text-[12vw] font-medium leading-none text-[#D1BD8F]">
            65,000K+
          </p>
          <p className="mt-[2vw] max-w-[16vw] text-[1.1vw] font-medium leading-normal text-[#FFF3D8]">
            Dogs currently enrolled in our studies
          </p>
        </div>
        <div className="ml-auto max-w-fit">
          <p className="text-[6vw] font-medium leading-none text-[#D1BD8F]">
            240+
          </p>
          <p className="mt-[.7vw] max-w-[17.5vw] text-[1.1vw] font-medium leading-normal text-[#FFF3D8]">
            Research projects using data from the Dog Aging Project Terra
            Platform
          </p>
        </div>
        ...
        <div className="max-w-fit">
          ...
          <p className="mt-[.7vw] max-w-[17.5vw] text-[1.1vw] font-medium leading-normal text-[#FFF3D8]">
            Different primary activity categories for Dog Pack members
            (companion, service, assistance, working, agility, show, breeding,
            rescue, etc.)
          </p>
        </div>
        <div className="ml-auto max-w-fit">
