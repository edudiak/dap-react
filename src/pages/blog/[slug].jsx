...
export default function BlogDetails() {
  ...
  return (
    <div>
      <div
        className="relative px-4 pb-16 pt-8 md:pb-20 lg:px-[2%] lg:pb-[20rem] lg:pt-[4rem]"
        style={{
      ...
      >
        ...
        <div className="grid grid-cols-1 gap-x-6 md:grid-cols-7 lg:gap-x-[5.333rem]">
          <div className="col-span-1 mt-14 lg:mt-[20rem]">
          ...
          <div className="col-span-4 mt-14 lg:mt-[20rem]">
            <div className="leading-normal text-black lg:text-[2.4rem] lg:leading-normal">
              <div className="mb-14 lg:mb-[10.667rem]">
              ...
              <div className="mb-14 lg:mb-[10.667rem]">
                ...
                <p className="mb-4 lg:mb-[2.667rem]">
                  ...
                  understanding of what factors influence owners to provide
                  joint supplements to their dogs. Importantly, our current
                  results, based on cross sectional analysis, cannot test the
                  hypothesis that joint supplement use alters the risk of future
                  OA, and should not be interpreted as a test of the impact of
                  joint supplementation, as discussed in a previous blog post.
                </p>
                <p>
                  However, we are hopeful that in the future, longitudinal
                  studies in the Dog Aging Project will allow us to develop and
                  test hypotheses to determine if dogs without OA who are
                  provided a joint supplement are less likely to develop OA in
                  the future. The Dog Aging Project allows us to ask these
                  long-term questions that would be difficult in a clinical
                  setting.
                </p>
              </div>
              <div className="mb-14 lg:mb-[10.667rem]">
              ...
              <div className="mb-14 lg:mb-[10.667rem]">
                ...
                <p className="mb-4 lg:mb-[2.667rem]">
                  ...
                  diagnosis are well established, the factors that are
                  associated with joint supplement use are not as well studied.
                  Using data collected from the Dog Aging Project, we analyzed
                  owner survey responses regarding joint supplement
                  administration and OA diagnosis for 26,951 adult dogs. In this
                  cross-sectional analysis, logistic regression models and
                  odds-ratios (OR) were employed to determine demographic
                  factors of dogs and their owners that were associated with
                ...
                <p>
                  ...
                  older age, larger size, and those that were ever overweight
                  were more likely to receive a joint supplement. Younger owner
                  age, urban living, owner education, and feeding commercial dry
                  food were associated with a reduced likelihood of
                  administration of joint supplements to dogs. Interestingly,
                  mixed breed dogs were also less likely to be administered a
                  joint supplement (OR: 0.73). Dogs with a clinical diagnosis of
                  OA were more likely to receive a joint supplement than those
                  without a reported OA diagnosis (OR: 3.82). Neutered dogs were
                  more likely to have a diagnosis of OA, even after controlling
                  for other demographic factors, yet their prevalence of joint
                  supplement administration was the same as intact dogs.
                  Overall, joint supplement use appears to be high in our large
                  population of dogs in the United States. Prospective studies
                  are needed to determine if joint supplements are more commonly
                  administered as a preventative for OA or after an OA clinical
                  diagnosis.
                </p>
              </div>
              <div>
