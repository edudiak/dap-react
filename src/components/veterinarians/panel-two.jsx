  ...
  return (
    <div className="relative -mt-[30px] overflow-hidden rounded-tl-[30px] rounded-tr-[30px] bg-white pb-20 lg:-mt-[10.667rem] lg:rounded-tl-[10.667rem] lg:rounded-tr-[10.667rem] lg:pb-[30rem]">
      ...
      <div className="mb-16 flex flex-wrap items-center px-5 pl-[4%] pr-[8%] lg:mb-[12rem]">
        <div className="ml-auto w-1/2 md:pr-[3%] lg:-mb-[25rem]">
          ...
          <div className="mt-5 flex gap-x-[2rem] lg:mt-[4rem]">
            <Link
              href="#"
        ...
        <div className="w-1/2 lg:-mt-[40rem]">
          <div>
            <h3 className="font-plex-mono mb-5 text-xl font-medium uppercase leading-none -tracking-[0.036rem] text-[#790F0F] md:text-2xl lg:mb-[4rem] lg:text-[3.6rem]">
