  ...
  return (
    <div ref={section4} className="relative overflow-hidden">
      <div className="section4_sticky_panels relative h-screen">
        <div
          ref={panel_1}
          className="absolute left-0 top-0 z-[3] flex h-[calc(100%-105px)] w-full items-center opacity-0 md:h-[calc(100%-115px)] md:items-start md:pt-[2.639vmax] lg:h-[calc(100%-23.125vmax)]"
        >
          <div className="mx-auto flex w-full flex-wrap items-start px-[5%] md:h-full md:flex-nowrap md:items-center">
            ...
            <div className="w-full md:w-1/2 md:pl-5">
              <div className="text-[#CAEBFF] lg:max-w-[36.458vmax]">
                <h4 className="mb-5 text-3xl uppercase md:mb-8 md:text-4xl lg:mb-[1.528vmax] lg:text-[3.125vmax] lg:leading-tight">
                  CANINE HEALTH
                </h4>
                <p className="mb-3 leading-snug md:mb-5 md:text-lg lg:mb-[1.528vmax] lg:text-[1.250vmax] lg:leading-snug">
                  Our team collects comprehensive health and diet data via
                  owner-reported surveys, veterinary medical records, and
                  frailty assessments.
                </p>
                <p className="leading-snug md:text-lg lg:text-[1.250vmax] lg:leading-snug">
        ...
        >
          <div className="mx-auto flex w-full flex-wrap items-start px-[5%] md:h-full md:flex-nowrap md:items-center">
            ...
            <div className="w-full md:w-1/2 md:pl-5">
              <div className="text-[#E5D8FF] lg:max-w-[36.458vmax]">
                <h4 className="mb-5 text-3xl uppercase md:mb-8 md:text-4xl lg:mb-[1.528vmax] lg:text-[3.125vmax] lg:leading-tight">
                  CANINE GENETICS
                </h4>
                <p className="mb-3 leading-snug md:mb-5 md:text-lg lg:mb-[1.528vmax] lg:text-[1.250vmax] lg:leading-snug">
        ...
        >
          <div className="mx-auto flex w-full flex-wrap items-start px-[5%] md:h-full md:flex-nowrap md:items-center">
            ...
            <div className="w-full md:w-1/2 md:pl-5">
              <div className="text-[#FFF9ED] lg:max-w-[36.458vmax]">
                <h4 className="mb-5 text-3xl uppercase md:mb-8 md:text-4xl lg:mb-[1.528vmax] lg:text-[3.125vmax] lg:leading-tight">
        ...
        >
          <div className="mx-auto flex w-full flex-wrap items-start px-[5%] md:h-full md:flex-nowrap md:items-center">
            ...
            <div className="w-full md:w-1/2 md:pl-5">
              <div className="text-[#FFF3D8] lg:max-w-[36.458vmax]">
                <h4 className="mb-5 text-3xl uppercase md:mb-8 md:text-4xl lg:mb-[1.528vmax] lg:text-[3.125vmax] lg:leading-tight">
                  CANINE LIFESTYLE
                </h4>
                <p className="leading-snug md:text-lg lg:text-[1.250vmax] lg:leading-snug">
        ...
        >
          <div className="mx-auto flex w-full flex-wrap items-start px-[5%] md:h-full md:flex-nowrap md:items-center">
            ...
            <div className="w-full md:w-1/2 md:pl-5">
              <div className="text-[#FFDADA] lg:max-w-[36.458vmax]">
                <h4 className="mb-5 text-3xl uppercase md:mb-8 md:text-4xl lg:mb-[1.528vmax] lg:text-[3.125vmax] lg:leading-tight">
                  BRAIN HEALTH
                </h4>
                <p className="leading-snug md:text-lg lg:text-[1.250vmax] lg:leading-snug">
        ...
        >
          <div className="mx-auto flex w-full flex-wrap items-start px-[5%] md:h-full md:flex-nowrap md:items-center">
            ...
            <div className="w-full md:w-1/2 md:pl-5">
              <div className="text-[#FFF7F8] lg:max-w-[36.458vmax]">
                <h4 className="mb-5 text-3xl uppercase md:mb-8 md:text-4xl lg:mb-[1.528vmax] lg:text-[3.125vmax] lg:leading-tight">
                  CANINE ACTIVITY
                </h4>
                <p className="leading-snug md:text-lg lg:text-[1.250vmax] lg:leading-snug">
        ...
        >
          <div className="mx-auto flex h-[calc(100%-105px)] w-full items-center px-5 md:h-[calc(100%-115px)] lg:h-[calc(100%-23.125vmax)] lg:pl-[16%] lg:pr-[4%]">
            <div className="w-full text-[#E8DCFF]">
              <div className="lg:max-w-[40.278vmax]">
                <h4 className="text-3xl leading-tight tracking-tighter md:text-4xl lg:text-[3.819vmax] lg:leading-none">
                  Accelerating scientific discovery & innovation for dogs and
                  humans
                </h4>
                <p className="font-plex-mono my-4 text-xl font-medium uppercase leading-snug md:my-6 md:text-2xl lg:mb-[1.042vmax] lg:mt-[2.083vmax] lg:text-[1.875vmax] lg:leading-snug">
                  Our Research Goals
                </p>
                <p className="leading-snug lg:text-[1.250vmax] lg:leading-snug">
              ...
              <div className="ml-auto mt-4 leading-snug md:mt-8 lg:-mt-[5.208vmax] lg:lg:max-w-[36.458vmax] lg:text-[1.250vmax] lg:leading-snug">
      ...
      <div className="absolute bottom-1 left-0 z-[2] px-2 md:w-full lg:bottom-[0.521vmax] lg:px-[5%]">
        <div className="relative flex w-[1200px] gap-2 py-4 md:w-full md:justify-center lg:gap-[1.042vmax] lg:py-[1.042vmax]">
          <div className="absolute left-[5%] top-0 bg-[#9169E8] lg:h-[0.347vmax] lg:w-[90%]" />
          <div className="absolute bottom-0 left-[5%] bg-[#9169E8] lg:h-[0.347vmax] lg:w-[90%]" />
          <div className="relative w-[130px] lg:w-auto">
            ...
            <div
              ref={panel_box_1}
              className="box relative z-[2] flex h-24 items-center justify-center rounded-[10px] bg-[#B894FF] text-center uppercase text-white shadow-[0px_0px_14px_3px_rgba(0,0,0,0.3)] md:h-28 lg:h-[11.458vmax] lg:w-[12.500vmax] lg:rounded-[1.389vmax]"
            >
              <div className="relative w-full">
                <p className="mb-2 text-base leading-none lg:mb-[1.042vmax] lg:text-[1.528vmax]">
                  Health
                </p>
                <p className="inline-block rounded-full border border-white px-3 py-1 text-[10px] lg:text-[0.694vmax]">
                  explore
                </p>
              </div>
            </div>
          ...
          <div className="relative w-[130px] lg:w-auto">
            ...
            <div
              ref={panel_box_2}
              className="box relative z-[2] flex h-24 items-center justify-center rounded-[10px] bg-[#B894FF] text-center uppercase text-white shadow-[0px_0px_14px_3px_rgba(0,0,0,0.3)] md:h-28 lg:h-[11.458vmax] lg:w-[12.5vmax] lg:rounded-[1.389vmax]"
            >
              <div className="relative w-full">
                <p className="mb-2 text-base leading-none lg:mb-[1.042vmax] lg:text-[1.528vmax]">
                  Genetics
