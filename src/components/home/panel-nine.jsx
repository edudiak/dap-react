...
export default function HomePanelNine() {
  ...
  return (
    ...
    >
      <h2
        ref={elm_1}
        className="will-change-transform-opacity mb-14 max-w-[585px] text-4xl tracking-tight text-[#D8C4FF] md:text-5xl lg:mb-[10rem] lg:max-w-[77rem] lg:text-[8.133rem] lg:-tracking-[0.244rem]"
      >
        The scope & scale of our research
      </h2>
      <div
        ref={elm_2}
        className="will-change-transform-opacity flex flex-wrap items-start md:flex-nowrap"
      >
      ...
      <div
        ref={elm_3}
        className="will-change-transform-opacity ml-auto mt-8 max-w-fit lg:mt-0"
      >
      ...
      <div
        ref={elm_4}
        className="will-change-transform-opacity mx-auto mt-8 max-w-fit lg:mt-0"
      >
        <p className="text-[80px] font-medium leading-none text-[#D1BD8F] lg:text-[14rem]">
          23K+
        </p>
      ...
      <div
        ref={elm_5}
        className="will-change-transform-opacity mt-8 max-w-fit lg:mt-0"
      >
        <p className="text-[80px] font-medium leading-none text-[#D1BD8F] lg:text-[14rem]">
          22K+
        </p>
      ...
      <div
        ref={elm_6}
        className="will-change-transform-opacity my-8 flex flex-wrap items-start justify-end md:flex-nowrap lg:my-[4rem]"
      >
        <p className="mr-4 text-[70px] font-medium leading-none text-[#D1BD8F] md:text-[100px] lg:mr-[7rem] lg:text-[24rem]">
          22,000+
        </p>
      ...
      <div ref={elm_7} className="will-change-transform-opacity max-w-fit">
        <p className="text-[80px] font-medium leading-none text-[#D1BD8F] lg:text-[14rem]">
          11K+
        </p>
      ...
      <div
        ref={elm_10}
        className="will-change-transform-opacity mt-5 flex flex-wrap items-start md:flex-nowrap lg:mt-[10rem]"
      >
        <p className="mr-4 text-[70px] font-medium leading-none text-[#D1BD8F] md:text-[100px] lg:mr-[7rem] lg:text-[24rem]">
          35,000+
        </p>
