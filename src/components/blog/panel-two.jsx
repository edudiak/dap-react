...
export default function PanelTwo() {
  ...
  return (
    <div className="px-5 lg:mt-0 lg:px-[4%]">
          ...
          >
            ...
            <div className="flex h-full flex-wrap-reverse items-stretch justify-center gap-y-8 overflow-hidden rounded-3xl text-[#250A60] sm:flex-nowrap lg:min-h-[20.6rem] lg:rounded-[2.667rem]">
              <div className="flex w-full flex-col justify-between p-4 sm:w-7/12 lg:p-[3rem]">
                ...
                >
                  Read More
                  <div className="svg_icon ml-1 flex h-5 w-5 items-center justify-center rounded-full border-2 border-[#532EA4] text-transparent sm:p-0 lg:ml-[1rem] lg:h-[3.333rem] lg:w-[3.333rem]">
      ...
      <div className="mb-20 mt-10 flex items-center justify-center gap-x-[1rem] text-xl font-bold leading-none text-[#532EA4] lg:mt-[8rem] lg:text-[2.8rem]">
