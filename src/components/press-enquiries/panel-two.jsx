...
export default function PanelTwo() {
  ...
  return (
    <>
      <div className="mb-16 px-5 md:mb-20 lg:mb-[20rem] lg:px-[8%]">
        <div className="mb-20 w-full lg:mb-[11.333rem] lg:w-1/2">
          <h2 className="mb-6 text-4xl font-medium leading-none text-[#514730] lg:mb-[4rem] lg:text-[6.267rem] lg:-tracking-[0.114rem]">
            Project Background
          </h2>
        ...
        <div className="mb-20 grid grid-cols-1 gap-x-5 gap-y-10 md:grid-cols-2 lg:mb-[11.333rem] lg:grid-cols-3 lg:gap-x-[5rem] lg:gap-y-[11.333rem] lg:text-[2.4rem]">
          {projectBackgrounds.map((project) => (
            <div key={project.title} cla>
              ...
              <a
                href={project.link}
                className="mt-4 flex items-center justify-end font-bold text-black lg:mt-[2.667rem]"
              >
                Download PDF
