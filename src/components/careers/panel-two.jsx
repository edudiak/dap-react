  ...
  return (
    <div className="relative px-5 pt-16 lg:pl-[8%] lg:pr-[2%] lg:pt-[13.333rem]">
      ...
      {openPositions.map((position) => (
        <div
          key={position.title}
          className="mb-4 flex border-b-2 border-b-[#6543A5] pb-2 text-lg font-medium leading-snug text-[#250A60] lg:mb-[4rem] lg:border-b-[0.267rem] lg:pb-[1rem] lg:text-[2.8rem]"
        >
